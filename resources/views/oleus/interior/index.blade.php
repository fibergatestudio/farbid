    ...
    <article class="uk-article uk-margin-large-bottom">
        ...
        <div class="uk-card uk-card-default uk-card-small">
            <div class="uk-card-header uk-text-right">
                {!! _l(__('fields.button_add'), 'oleus.interior.create', ['a' => ['class' => 'uk-button uk-button-secondary uk-waves']]) !!}
            </div>
                        ...
                        <tbody>
                            @foreach($items as $item)
                                <tr>
                                    ...
                                    <td class="uk-text-center">
                                        {!! _l('', 'oleus.interior.edit', ['p' => ['id' => $item->id], 'a' => ['class' => 'uk-button-icon uk-button uk-button-primary uk-waves',  'uk-icon' => 'icon: ui_mode_edit']]) !!}
                                    </td>
                                </tr>
                            @endforeach
                        </tbody>
