...
@section('page')
    <article class="uk-article uk-margin-large-bottom">
        ...
        <div class="uk-card uk-card-default uk-card-small uk-border-rounded">
            @can('create_advantages')
                <div class="uk-card-header uk-text-right">
                    {!! _l(trans('forms.button_add'), 'oleus.advantages.create', ['a' => ['class' => 'uk-button uk-button-secondary uk-waves uk-border-rounded']]) !!}
                </div>
            @endcan
                                ...
                                <tr>
                                    ...
                                    @can('update_advantages')
                                        <td class="uk-text-right">
                                            {!! _l('', 'oleus.advantages.edit', ['p' => ['id' => $item->id], 'a' => ['class' => 'uk-text-primary',  'uk-icon' => 'icon: ui_mode_edit', 'uk-tooltip' => 'title: '. trans('forms.button_edit')]]) !!}
                                        </td>
                                    @endcan
                                </tr>
                            @endforeach
