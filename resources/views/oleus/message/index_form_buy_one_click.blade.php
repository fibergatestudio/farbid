                    ...
                    <table class="uk-table uk-table-small uk-table-hover uk-table-middle">
                        <thead>
                            <tr>
                                ...
                                <th class="uk-width-medium">@lang('forms.label_modal_user_email')</th>
                                <th class="uk-width-medium">@lang('forms.label_subject')</th>
                        ...
                        <tbody>
                            @foreach($items as $item)
                                <tr>
                                    ...
                                    @can('viewed_callback')
                                        <td class="uk-text-center">
                                            {!! _l('', 'oleus.message.edit', ['p' => ['id' => $item->id], 'a' => ['class' => 'uk-button-icon uk-button uk-button-secondary uk-waves uk-border-rounded',  'uk-icon' => 'icon: ui_visibility', 'uk-tooltip' => 'title: '. trans('forms.button_view')]]) !!}
                                        </td>
                                    @endcan
                                </tr>
                            @endforeach
