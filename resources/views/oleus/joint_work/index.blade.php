    ...
    <article class="uk-article uk-margin-large-bottom">
        ...
        <div class="uk-card uk-card-default uk-card-small">
            <div class="uk-card-header uk-text-right">
                {!! _l(__('fields.button_add'), 'oleus.joint_work.create', ['a' => ['class' => 'uk-button uk-button-secondary uk-waves']]) !!}
            </div>
                    ...
                    <table class="uk-table uk-table-small uk-table-hover uk-table-middle">
                        <thead>
                            <tr>
                                ...
                                <th class="uk-width-medium">{{ __('pages.sub_title') }}</th>
                                <th class="uk-width-xsmall uk-text-center">
                                    <span uk-icon="icon: ui_title"
                            ...
                            @foreach($items as $item)
                                <tr>
                                    ...
                                    <td class="uk-text-center">
                                        {!! !$item->hidden_title ? '<span class="uk-text-success" uk-icon="icon: ui_visibility"></span>' : '<span class="uk-text-danger" uk-icon="icon: ui_visibility_off"></span>' !!}
                                    </td>
                                    <td class="uk-text-center">
                                    ...
                                    <td class="uk-text-center">
                                        {!! _l('', 'oleus.joint_work.edit', ['p' => ['id' => $item->id], 'a' => ['class' => 'uk-button-icon uk-button uk-button-primary uk-waves',  'uk-icon' => 'icon: ui_mode_edit']]) !!}
                                    </td>
                                </tr>
                            @endforeach
                        </tbody>
